...
<body>
  ...
  <div class="nav">
    ...
    <div class="nav-header">
      <div class="nav-title">
        <a href="http://localhost/Project/Apna%20karobar/index.php">
          <img src="images/logo.png" alt="logo" width="270px" height="80px"> </a>
    ...
    <div class="nav-links">
      ...
      <a href="http://localhost/Project/Apna%20karobar/signup.php"> <button class="btn login">Sign up </button> </a>
...
-->
  ...
  <!-- BOdy -->
  <!-- carseol -->
  <div class="container-fuild py-2">
    <div class="carousel">
      ...
      <ul class="carousel__items">
        <li class="carousel__item"><img src="./images/c1.png" alt="" width="100%" height="100%"></li>
        <li class="carousel__item"><img src="./images/c2.png" alt="" width="100%" height="100%"></li>
        <li class="carousel__item"><img src="./images/c3.png" alt="" width="100%" height="100%"></li>
        <li class="carousel__item"><img src="./images/c4.png" alt="" width="100%" height="100%"></li>
        <li class="carousel__item"><img src="./images/c5.png" alt="" width="100%" height="100%"></li>
      </ul>
  ...
  <div class="blog-card alt">
    ...
    <div class="description">
      <h1 class="headingCards">lEDGER</h1>
  ...
  <footer class="flex-rw ">
    <a href="index.html"> <img src="images/logo.png" alt="logo" width="470px" height="180px " class="mt"> </a>

    <ul class="footer-list-top">
      <li>
        <h4 class="footer-list-header py-4">About Apna Karobar</h4>
      </li>
      <li><a href='aboutus.html' class="generic-anchor footer-list-anchor text-decoration-none" itemprop="significantLink">GET TO KNOW US</a></li>
      <li><a href='#' itemprop="significantLink" class="generic-anchor footer-list-anchor text-decoration-none">JOB OPENINGS</a></li>
      <li><a href='./contact.html' class="generic-anchor footer-list-anchor text-decoration-none" itemprop="significantLink">CONTACT</a></li>

      <li><a href='#' class="generic-anchor footer-list-anchor text-decoration-none" itemprop="significantLink">EVENTS</a></li>
      <li><a href='/faq.html' class="generic-anchor footer-list-anchor text-decoration-none" itemprop="significantLink">FAQ</a></li>
    ...
    <section class="footer-bottom-section flex-rw">
      <div class="footer-bottom-wrapper">
        ...
        </i> 2019 Apna Karobar <address class="footer-address" role="company address">Lahore</address><span class="footer-bottom-rights"> - All Rights Reserved - </span>
      </div>
      <div class="footer-bottom-wrapper">
        <a href="#" class="generic-anchor text-decoration-none" rel="nofollow">Terms</a> | <a href="#" class="generic-anchor text-decoration-none" rel="nofollow">Privacy</a>
      </div>
    </section>
  </footer>
