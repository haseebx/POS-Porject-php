...
<body>
  ...
  <div class="main">
    ...
    <form class="form1" method="POST" action="loginScript.php">
      <!--  
      <input
          class="un"
          type="email"
          ...
          placeholder="Email"
        /> -->
      <input class="un" type="text" text-align="center" placeholder="Username" name="username" />
      <input class="pass" type="password" text-align="center" placeholder="Password" name="password" />
      <input class="submit" type="submit" value="Log In">

      <div class="message">
        <p class="forgot center ">Forgot Password?</p>
        <p class="message center py-2">
          Not registered? <a href="http://localhost/Project/Apna%20karobar/signup.php">Create an account</a>
        </p>
      </div>
    </form>
  </div>
